        ...
        <>
            ...
            searchProducts(values)}
                ...
                {(FormikProps) => (
                        ...
                        <div className="row gx-3 align-items-center">
                            ...
                            <div className='col-auto'>
                                <div className='form-check'>
                                    <Field className='form-check-input' id="isAvalible" name='isAvalible' type='checkbox'/>
                    ...
                    <Pagination totalAmountOfPages={totalAmountOfPages} onChange={newPage =>{FormikProps.values.page= newPage; searchProducts(FormikProps.values)}} currentPage={FormikProps.values.page}/>
